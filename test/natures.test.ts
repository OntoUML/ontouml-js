...
describe(`Test ontological nature handling utility`, () => {
  describe('Test natures array', () => {
    it('There should be a know number of natures', () =>
      expect(natureUtils.Natures).toHaveLength(11));
  ...
  describe('Test endurant natures array', () => {
    it('There should be a know number of natures', () =>
      expect(natureUtils.EndurantNatures).toHaveLength(7));
    it('Each of these must be a in the array', () => {
  ...
  describe('Test substantial natures array', () => {
    it('There should be a know number of natures', () =>
      expect(natureUtils.SubstantialNatures).toHaveLength(3));
    it('Each of these must be a in the array', () => {
      expect(natureUtils.SubstantialNatures).toContain(
  ...
  describe('Test moment natures array', () => {
    it('There should be a know number of natures', () =>
      expect(natureUtils.MomentNatures).toHaveLength(4));
    it('Each of these must be a in the array', () => {
  ...
  describe('Test intrinsic moment natures array', () => {
    it('There should be a know number of natures', () =>
      expect(natureUtils.IntrinsicMomentNatures).toHaveLength(2));
    it('Each of these must be a in the array', () => {
      expect(natureUtils.IntrinsicMomentNatures).toContain(
  ...
  describe('Test extrinsic moment natures array', () => {
    it('There should be a know number of natures', () =>
      expect(natureUtils.ExtrinsicMomentNatures).toHaveLength(2));
    it('Each of these must be a in the array', () => {
      expect(natureUtils.ExtrinsicMomentNatures).toContain(
