...
import { Project, Relation, RelationStereotype, ClassStereotype, Property } from '../src';
...
describe('Relation Tests', () => {
  ...
  describe('Test getSourceClass()', () => {
    ...
    it('Test exception on derivation relation', () => expect(() => derivation.getSourceAsClass()).toThrow());
    it('Test exception on ternary relation', () => expect(() => metPersonAt.getSourceAsClass()).toThrow());
  });
  ...
  describe('Test getTargetClass()', () => {
    ...
    it('Test exception on derivation relation', () => expect(() => derivation.getTargetAsClass()).toThrow());
    it('Test exception on ternary relation', () => expect(() => metPersonAt.getTargetAsClass()).toThrow());
  });
  ...
  describe('Test getMemberClass()', () => {
    ...
    it('Test exception on binary relation', () => expect(() => heavierThan.getMemberAsClass(0)).toThrow());
    it('Test exception on derivation relation', () => expect(() => derivation.getMemberAsClass(0)).toThrow());
  });
