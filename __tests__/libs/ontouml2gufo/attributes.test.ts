...
describe('Attributes', () => {
  ...
  it('should generate "capacity" as an int DatatypeProperty', async () => {
    expect(alpinebits).toContain('<:capacity> <rdf:type> <owl:DatatypeProperty>');
    expect(alpinebits).toContain('<:capacity> <rdfs:subPropertyOf> <gufo:hasQualityValue>');
  ...
  it('should generate "description" as a string DatatypeProperty', async () => {
    expect(alpinebits).toContain('<:description> <rdf:type> <owl:DatatypeProperty>');
    expect(alpinebits).toContain('<:description> <rdfs:subPropertyOf> <gufo:hasQualityValue>');
    expect(alpinebits).toContain('<:description> <rdfs:domain> <:NamedIndividual>');
  ...
  it('should generate attributes of datatypes classes without rdfs:subPropertyOf gufo:hasQualityValue', async () => {
    ...
    expect(alpinebits).not.toContain('<:lower> <rdfs:subPropertyOf> <gufo:hasQualityValue>');
  });
  ...
  it('should generate attributes of stereotype classes with rdfs:subPropertyOf gufo:hasQualityValue', async () => {
    ...
    expect(alpinebits).toContain('<:area> <rdfs:subPropertyOf> <gufo:hasQualityValue>');
