...
const gChecker_026_flatting_to_class_association = new GraphChecker()
  ...
  .addTracker(
    new TrackerChecker('PersonAssociatedClass1', 'person_associated_class1'),
  )
  .addTracker(
    new TrackerChecker('PersonAssociatedClass2', 'person_associated_class2'),
  );
