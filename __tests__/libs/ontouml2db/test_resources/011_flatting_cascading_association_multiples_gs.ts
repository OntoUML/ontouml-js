...
export const test_011: TestResource = {
  title:
    '011 Evaluates the flatting with one association and multiples generalization sets',
  model: require('./test_011_flatting_cascading_association_multiples_gs.json'),
