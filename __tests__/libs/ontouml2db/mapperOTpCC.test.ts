 ...
 */
 ...
 const scriptFKPrimatyOrgnization = 'ALTER TABLE primary_school ADD FOREIGN KEY ( organization_id ) REFERENCES organization ( organization_id );';
 
 const scriptFKHospitalOrganization = 'ALTER TABLE hospital ADD FOREIGN KEY ( organization_id ) REFERENCES organization ( organization_id );';
 ...
 const scritpFKPersonalCustomerAdult = 'ALTER TABLE personal_customer ADD FOREIGN KEY ( person_id ) REFERENCES adult ( person_id );';
 
 const scriptFKCorporateOrganization = 'ALTER TABLE corporate_customer ADD FOREIGN KEY ( organization_id ) REFERENCES organization ( organization_id );';
 
 const scriptFKContractorOrganization =  'ALTER TABLE contractor ADD FOREIGN KEY ( organization_id ) REFERENCES organization ( organization_id );';
 ...
 const scriptFKEmploymentOrganization = 'ALTER TABLE employment ADD FOREIGN KEY ( organization_id ) REFERENCES organization ( organization_id );';
 
 const scriptFKEmploymentEmployee = 'ALTER TABLE employment ADD FOREIGN KEY ( person_id ) REFERENCES employee ( person_id );';
 
 const scriptFKEnrollmentSchool = 'ALTER TABLE enrollment ADD FOREIGN KEY ( organization_id ) REFERENCES primary_school ( organization_id );';
 
 const scriptFKEnrollmentChild =  'ALTER TABLE enrollment ADD FOREIGN KEY ( person_id ) REFERENCES child ( person_id );';
 
 const scriptFKSupplyCorporateCustomer = 'ALTER TABLE supply_contract ADD FOREIGN KEY ( organization_customer_id ) REFERENCES corporate_customer ( organization_id );';
 
 const scriptFKSupplyPersonalCustomer =  'ALTER TABLE supply_contract ADD FOREIGN KEY ( person_id ) REFERENCES personal_customer ( person_id );';

 const scriptFKSupplyContractor =  'ALTER TABLE supply_contract ADD FOREIGN KEY ( organization_id ) REFERENCES contractor ( organization_id );';
