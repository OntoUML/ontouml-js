...
describe('Database transformation test', () => {
	...
	test('Run Example', () => {
		...
		let gChecker = new GraphChecker()
				...
				.addNode( new NodeChecker('person')
				...
				.addNode( new NodeChecker('organization')
				...
				.addNode( new NodeChecker('enrollment')
	...
	test('007 Flatting Category Without Specialization', () => {
		...
		let gChecker = new GraphChecker()
			...
			.addNode( new NodeChecker('named_entity_a')
	...
	test('009 Flatting Cascading Association', () => {
		...
		let gChecker = new GraphChecker()
			...
			.addNode( new NodeChecker('person_b')
			...
			.addNode( new NodeChecker('organization_b')
	...
	test('010 Flatting Cascading Association With Multiples Generalizations', () => {
		...
		let gChecker = new GraphChecker()
			.setTransformation(mapper)
			.addNode( new NodeChecker('organization_a')
			...
			.addNode( new NodeChecker('organization_c')
					.addProperty( new PropertyChecker('organization_c_id', false) )
					.addProperty( new PropertyChecker('name', false) )  
					)
			.addNode( new NodeChecker('organization_d')
	...
	test('021 Lifting Generalization And Generalization Set With Association', () => {
		...
		let gChecker = new GraphChecker()
			...
			.addNode( new NodeChecker('employment_a') 
					.addProperty( new PropertyChecker('employment_a_id', false) )
					.addProperty( new PropertyChecker('person_id', false) )
					)
			.addNode( new NodeChecker('employment_b') 
	...
	test('022 Lifting GS Disjoint Complete', () => {
		...
		let gChecker = new GraphChecker()
			.setTransformation(mapper)
			.addNode( new NodeChecker('super_class')
			...
			.addNode( new NodeChecker('associated_class') 
	...
	test('024 Lifting GS Overlapping Complete', () => {
		...
		let gChecker = new GraphChecker()
			...
			.addNode( new NodeChecker('super_class_type')
	...
	test('026 Flatting To Class Association', () => {
		...
		let gChecker = new GraphChecker()
			...
			.addNode( new NodeChecker('associated_class1')
					.addProperty( new PropertyChecker('associated_class1_id', false) )
					)
			.addNode( new NodeChecker('associated_class2')
					.addProperty( new PropertyChecker('associated_class2_id', false) )
					)
			.addNode( new NodeChecker('associated_class3')
					.addProperty( new PropertyChecker('associated_class3_id', false) )
					)
			.addNode( new NodeChecker('associated_class4')
					.addProperty( new PropertyChecker('associated_class4_id', false) )
					)
			.addRelationship( new RelationshipChecker('person', Cardinality.C0_N, 'associated_class1', Cardinality.C0_N) )
			.addRelationship( new RelationshipChecker('person', Cardinality.C0_N, 'associated_class2', Cardinality.C1_N) )
