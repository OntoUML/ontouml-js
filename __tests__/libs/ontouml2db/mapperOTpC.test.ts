...
const scriptFKOrganizationNamed = 'ALTER TABLE organization ADD FOREIGN KEY ( named_entity_id ) REFERENCES named_entity ( named_entity_id );';

const scriptFKPrimatyOrgnization = 'ALTER TABLE primary_school ADD FOREIGN KEY ( named_entity_id ) REFERENCES organization ( named_entity_id );';

const scriptFKHospitalOrganization = 'ALTER TABLE hospital ADD FOREIGN KEY ( named_entity_id ) REFERENCES organization ( named_entity_id );';

const scriptFKBrazilianPerson = 'ALTER TABLE brazilian_citizen ADD FOREIGN KEY ( named_entity_id ) REFERENCES person ( named_entity_id );';

const scriptFKItalianPerson = 'ALTER TABLE italian_citizen ADD FOREIGN KEY ( named_entity_id ) REFERENCES person ( named_entity_id );';

const scriptFKEmployeAdult = 'ALTER TABLE employee ADD FOREIGN KEY ( named_entity_id ) REFERENCES adult ( named_entity_id );';

const scritpFKPersonalCustomerAdult = 'ALTER TABLE personal_customer ADD FOREIGN KEY ( named_entity_id ) REFERENCES adult ( named_entity_id );';

const scriptFKPersonalCustomerCustomer = 'ALTER TABLE personal_customer ADD FOREIGN KEY ( customer_id ) REFERENCES customer ( customer_id );';
    
const scriptFKCorporateOrganization = 'ALTER TABLE corporate_customer ADD FOREIGN KEY ( named_entity_id ) REFERENCES organization ( named_entity_id );';

const scriptFKCorporateCustomer = 'ALTER TABLE corporate_customer ADD FOREIGN KEY ( customer_id ) REFERENCES customer ( customer_id );';

const scriptFKContractorOrganization = 'ALTER TABLE contractor ADD FOREIGN KEY ( named_entity_id ) REFERENCES organization ( named_entity_id );';
...
const scriptFKEmploymentOrganization= 'ALTER TABLE employment ADD FOREIGN KEY ( named_entity_organization_id ) REFERENCES organization ( named_entity_id );';
    
const scriptFKEmploymentEmployee = 'ALTER TABLE employment ADD FOREIGN KEY ( named_entity_id ) REFERENCES employee ( named_entity_id );';
    
const scriptFKEnrollmentSchool = 'ALTER TABLE enrollment ADD FOREIGN KEY ( named_entity_primary_school_id ) REFERENCES primary_school ( named_entity_id );';
    
const scriptFKEnrollmentChild = 'ALTER TABLE enrollment ADD FOREIGN KEY ( named_entity_id ) REFERENCES child ( named_entity_id );';
    
const scriptFKSupplyCustomer = 'ALTER TABLE supply_contract ADD FOREIGN KEY ( customer_id ) REFERENCES customer ( customer_id );';
    
const scriptFKSupplyContractor = 'ALTER TABLE supply_contract ADD FOREIGN KEY ( named_entity_id ) REFERENCES contractor ( named_entity_id );';
...
const graphChecker: GraphChecker = new GraphChecker()
    ...
    .addScriptChecker(new ScriptChecker(scriptFKPersonNamed, 'The FK between PERSONAL and NAMED_ENTITY not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKOrganizationNamed, 'The FK between ORGANIZATION and NAMED_ENTITY not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKPrimatyOrgnization, 'The FK between PRIMARY_SCHOOL and ORGANIZATION not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKHospitalOrganization, 'The FK between HOSPITAL and ORGANIZATION not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKBrazilianPerson, 'The FK between BRAZILIAN_CITIZEN and PERSON not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKItalianPerson, 'The FK between ITALIAN_CITIZEN and PERSON not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKEmployeAdult, 'The FK between EMPLOYEE and ADULT not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scritpFKPersonalCustomerAdult, 'The FK between PERSONAL_CUSTOMER and ADULT not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKPersonalCustomerCustomer, 'The FK between PERSONAL_CUSTOMER and CUSTOMER not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKCorporateOrganization, 'The FK between CORPORATE_CUSTOMER and ORGANIZATION not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKCorporateCustomer, 'The FK between CORPORATEL_CUSTOMER and CUSTOMER not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKContractorOrganization, 'The FK between CONTRACTOR and ORGANIZATION not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKChildPerson, 'The FK between CHILD and PERSON not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKAdultPerson, 'The FK between ADULT and PERSON not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKEmploymentOrganization, 'The FK between EMPLOYMENT and ORGANIZATINO not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKEmploymentEmployee, 'The FK between EMPLOYMENT and EMPLOYEE not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKEnrollmentSchool, 'The FK between ENROLLMENT and SCHOOL not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKEnrollmentChild, 'The FK between ENROLLMENT and CHILD not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKSupplyCustomer, 'The FK between SUPPLAY_CONTRACTO and CUSTOMER not exists or is different than expected.'))
    .addScriptChecker(new ScriptChecker(scriptFKSupplyContractor, 'The FK between SUPPLAY_CONTRACT and CONTRACTOR not exists or is different than expected.'))
    ;
