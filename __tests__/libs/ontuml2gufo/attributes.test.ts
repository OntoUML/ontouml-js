...
describe('Attributes', () => {
  ...
  it('should generate "capacity" as an int DatatypeProperty', async () => {
    ...
    expect(result).toContain('<:capacity> <rdfs:subPropertyOf> <gufo:hasQualityValue>');
  ...
  it('should generate "description" as a string DatatypeProperty', async () => {
    expect(result).toContain('<:description> <rdf:type> <owl:DatatypeProperty>');
    expect(result).toContain('<:description> <rdfs:subPropertyOf> <gufo:hasQualityValue>');
  ...
  it('should generate attributes of datatypes classes without rdfs:subPropertyOf gufo:hasQualityValue', async () => {
    ...
    expect(result).not.toContain('<:lower> <rdfs:subPropertyOf> <gufo:hasQualityValue>');
  });
  ...
  it('should generate attributes of stereotype classes with rdfs:subPropertyOf gufo:hasQualityValue', async () => {
    ...
    expect(result).toContain('<:area> <rdfs:subPropertyOf> <gufo:hasQualityValue>');
