...
export function generateWorldFieldForRelation(
  relationName: string,
  sourceName: string,
  targetname: string,
...
export function generateExistsConstraint(className: string, classNature: string): string {
  return 'exists:>' + classNature + ' in ' + className;
}
