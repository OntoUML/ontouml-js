...
describe('Classes', () => {
  ...
  it('should generate dcat:keyword', () => {
    expect(result).toContain('<http://t.co> <http://www.w3.org/ns/dcat#keyword> "risk"');
    expect(result).toContain('<http://t.co> <http://www.w3.org/ns/dcat#keyword> "value"');
  });
  ...
  it('should generate ocmv:ontologyType', () => {
    expect(result).toContain('<http://t.co> <https://w3id.org/ontouml-models/vocabulary#ontologyType> <https://w3id.org/ontouml-models/vocabulary#Core>');
  });
  ...
  it('should generate mod:designedForTask', () => {
    expect(result).toContain(
      '<http://t.co> <https://w3id.org/mod#designedForTask> <https://w3id.org/ontouml-models/vocabulary#ConceptualClarification>'
    );
  });

  it('should generate ontouml:context', () => {
    expect(result).toContain(
      '<http://t.co> <https://w3id.org/ontouml-models/vocabulary#context> <https://w3id.org/ontouml-models/vocabulary#Research>'
    );
  });
  ...
  it('should generate ocvm:representationStyle', () => {
    expect(result).toContain(
      '<http://t.co> <https://w3id.org/ontouml-models/vocabulary#representationStyle> <https://w3id.org/ontouml-models/vocabulary#OntoumlStyle>'
    );
  });
