...
export abstract class NamedElementBuilder<B extends NamedElementBuilder<B>> extends OntoumlElementBuilder<B> {
   ...
   description(value: string, language: string = MultilingualText.defaultLanguage): B {
