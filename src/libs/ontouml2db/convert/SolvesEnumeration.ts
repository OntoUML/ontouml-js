...
export class SolvesEnumeration{
	...
	private static addEnumerationColumn(enumNode: INode, relation: IGraphRelation): void {
	...
	private static getCardinalityOf(node: INode, relation: IGraphRelation): Cardinality {
		if( relation.getSourceNode() == node ) 
