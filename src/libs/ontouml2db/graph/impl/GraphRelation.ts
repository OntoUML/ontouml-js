...
export class GraphRelation extends GraphAssociation implements IGraphRelation{
    ...
    constructor(ID: string, sourceNdde: INode, sourceCardinality: Cardinality, targetNode: INode, targetCardinality: Cardinality){
    ...
    clone(newID?: string): IGraphRelation {
        if(newID != null){
            return new GraphRelation(newID, this.sourceNode, this.sourceCardinality, this.targetNode, this.targetCardinality);
        }
        else{
            return new GraphRelation(this.getAssociationID(), this.sourceNode, this.sourceCardinality, this.targetNode, this.targetCardinality);
        }
    }
