...
export class GraphGeneralization extends GraphAssociation implements IGraphGeneralization{

    private generalizationNode: INode;
    private specializationNode: INode;
    private belongToGS: IGraphGeneralizationSet;

    constructor(id: string, generalizationNode: INode, specializationNode: INode){
    ...
    cloneChangingReferencesTo(nodes: INode[]): IGraphGeneralization {
        ...
        let newGeneralizationNode: INode = Util.findNodeById(this.generalizationNode.getId(), nodes);
        let newSpecializationNode: INode = Util.findNodeById(this.specializationNode.getId(), nodes);
