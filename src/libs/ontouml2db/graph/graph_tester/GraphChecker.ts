...
export class GraphChecker{
    ...
    public check(): string{
		...
		if( this.relationships.length != this.targetGraph.getAssociations().length ) {
			return "The amount of RELATIONSHIPS does not match. Tested: " + this.relationships.length + ". Graph: " + this.targetGraph.getAssociations().length;
		}
