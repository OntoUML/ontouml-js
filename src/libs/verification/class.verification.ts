...
export const allNatures = [
  ...
  OntologicalNature['extrinsic-mode'],
  OntologicalNature.functional_complex,
  OntologicalNature['intrinsic-mode'],
...
export const allAllowedNatures = {
  ...
  [ClassStereotype.MODE]: [OntologicalNature['extrinsic-mode'], OntologicalNature['intrinsic-mode']],
